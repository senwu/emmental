"""Emmental e2e test with sample scorer."""
import logging
import shutil
...
def test_e2e_sample_scorer(caplog):
    """Run an end-to-end test."""
    caplog.set_level(logging.INFO)

    dirpath = "temp_test_e2e_sample_scorer"
    ...
    tasks = [
        EmmentalTask(
            ...
            sample_scorer=Scorer(metrics=task_metrics[task_name])
            if task_name in ["task1"]
            else None,
